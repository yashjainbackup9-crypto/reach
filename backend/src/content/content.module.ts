...
@Module({
    ...
    providers: [ToneService, TonesService, ContentRewriterService, ImageGenerationService, WebResearchService, VideoGenerationService],
    exports: [ToneService, TonesService, ContentRewriterService, ImageGenerationService, WebResearchService, VideoGenerationService],
})
